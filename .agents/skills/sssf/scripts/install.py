...
Stamps: adws/ (modules + starter ADWs), prompt engineering, the agent roster,
project-scoped .codex configuration/agents/hooks, .env.sample, justfile, and
.gitignore entries.
...
def main() -> int:
    ...
    stamp(TEMPLATES / "codex", root / ".codex", args.force, stamped, skipped)
    ...
    print("\nnext steps:")
    print("  1. codex login           # choose ChatGPT subscription authentication")
    print("  2. codex                 # trust this repo; review project hooks with /hooks")
    print("  3. edit adws/adw_modules/quality.py with real project commands")
    print("  4. just demo             # two read-only runs, end to end")
    print("  5. just sessions         # what just happened")
    print("  6. just obs              # the trace UI, needs bun")
    print("\n  no just? the raw form of step 4 is:")
