...
/** events.type — core lifecycle plus Codex native-subagent lifecycle. */
...
/**
 * Tokens per component for one Codex phase. ChatGPT subscription runs do not
 * disclose reliable per-run USD cost, so cost fields are normally null.
 */
